...
read1 = read.csv(file="./data/Anjali.csv", header = TRUE,sep = ",")
...
head(df_gsheet)
url_gsheet = "https://docs.google.com/spreadsheets/d/1Vs2-twUx2TMJjFw-UNt8qivDWlgM5rwd1fpqwgmRFmY/edit#gid=875238853"
url_gsheet = "https://docs.google.com/spreadsheets/d/1Vs2-twUx2TMJjFw-UNt8qivDWlgM5rwd1fpqwgmRFmY/edit#gid=875238853"
df_gsheet = as.data.frame(gsheet2tbl(url_gsheet))
head(df_gsheet)
